        ...
        <>
          <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-3">
            <Card>
              ...
              <CardContent>
                <div className="text-xl font-bold tabular-nums sm:text-2xl text-green-600">{formatCurrency(data.summary.total_cash_in)}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-xl font-bold tabular-nums sm:text-2xl text-red-600">{formatCurrency(data.summary.total_cash_out)}</div>
